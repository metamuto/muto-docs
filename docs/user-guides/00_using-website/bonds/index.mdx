...
Muto offers two types of bonds [on its website](https://app.Mutodao.finance/#/bonds), reserve and liquidity bonds.
...
1. Go to the [Bonds page](https://app.Mutodao.finance/#/bonds) and select the bond type you want to purchase.
...
- _An "Approve" transaction is needed when bonding an asset for the first time; this transaction gives the [Muto bond contract](../../contracts/bonds) the permission to execute the bond. Subsequent bonding only requires you to perform the "Bond" transaction._

## **How to Redeem**

Go to the [Bonds page](https://app.Mutodao.finance/#/bonds).
