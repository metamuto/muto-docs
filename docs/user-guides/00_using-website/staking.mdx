...
Staking allows you to earn OHM passively via auto-compounding. By staking your OHM with MutoDAO, you receive sOHM (staked OHM) in return at a 1:1 ratio. After that, your sOHM balance will increase automatically on every epoch based on the current APY.

Check out this video on how to get OHM and stake it on Muto:

<YouTube youTubeId="aXAE1ikVMpM" alt="How to get OHM and stake it on Muto"/>
...
1. Go to the [Stake page of the MutoDAO website](https://app.Mutodao.finance/#/). Select the "Stake" tab.
...
1. Go to the [Stake page of the MutoDAO website](https://app.Mutodao.finance/#/). Select the "Unstake" tab.
...
**TVL** measures the dollar amount of all the staked OHM in Muto.
