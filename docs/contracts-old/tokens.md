...
The Current Index is how many OHM one would have if they staked 1 OHM since the protocol inception. Check out the [muto dashboard](https://app.mutodao.finance/#/dashboard) for the Current Index value.
{% endhint %}
...
Below are listed OHM contracts by version, where the V2 token is the token in use after the [V2 migration](https://mutodao.medium.com/introducing-muto-v2-c4ade14e9fe).
...
Below are listed sOHM contracts by version. We have two V2 tokens, the older version is for the [previous migration](https://mutodao.medium.com/muto-v1-1-whats-in-it-293843a8d4dc), while the newer one is used for the [latest V2 migration](https://mutodao.medium.com/introducing-muto-v2-c4ade14e9fe).
